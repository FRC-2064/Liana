...
class FeederStatusButton extends StatusButton {
  const FeederStatusButton(
      {super.key,
        required super.name,
  ...
  @override
  State<FeederStatusButton> createState() => _FeederStatusButtonState();
}

class _FeederStatusButtonState extends State<FeederStatusButton> {
  @override
